...
public class Address   {
   ...
   * @return addressLine1
  **/
  @ApiModelProperty(example = "New jersey", required = true, value = "")
  @NotNull
   ...
   * @return addressLine2
  **/
  @ApiModelProperty(example = "road no1", value = "")
   ...
   * @return street
  **/
  @ApiModelProperty(example = "churchil", value = "")
   ...
   * @return postalCode
  **/
  @ApiModelProperty(example = "504105", required = true, value = "")
  @NotNull
